...
export default function Navbar() {
    return (
    <>
    <nav id="header" className="fixed w-full px-3 z-30 top-0 text-white bg-yellow-400">
      <div className="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-2">
        <div className="pl-4 flex items-center">
          <NavLink to="/"className="toggleColour text-white no-underline hover:no-underline font-bold text-2xl lg:text-4xl">
        ...
        <div className="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden mt-2 lg:mt-0 bg-white lg:bg-transparent text-black p-4 lg:p-0 z-20" id="nav-content">
          <ul className="list-reset lg:flex justify-end flex-1 items-center">
            ...
            <li className="mr-3">
              <NavLink to="/login"className="inline-block text-black no-underline hover:underline py-2 px-4 hover:scale-105 duration-300 ease-in-out" >LOGIN</NavLink>
            </li>
          </ul>
          <NavLink
            to="/join"
